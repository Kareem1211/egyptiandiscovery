$(document).ready(function() {
    ...
    //    $("body").not(".demo").prepend('<a href="https://1.envato.market/K77M9" target="_blank" class="buy-btn">Buy now</a>');
    //    $(".buy-btn").attr("onclick", "yaCounter64713664.reachGoal('TF'); return true;");
